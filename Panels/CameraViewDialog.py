...
class CameraViewDialog(QDialog):
    def __init__(self, parent=None, GridHeight=None, GridWidth=None):
        ...
        gridLayout.addWidget(QLabel("GX:"), 2, 0)
        gridLayout.addWidget(self.gxInput, 2, 1)
        gridLayout.addWidget(QLabel("GY:"), 3, 0)
        gridLayout.addWidget(self.gyInput, 3, 1)

        # Add save and cancel buttons
        saveButton = QPushButton('Save', self)
        cancelButton = QPushButton('Cancel', self)
        gridLayout.addWidget(saveButton, 4, 0)
